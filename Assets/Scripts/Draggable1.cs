...
public class Draggable1 : GrabbableBase<Draggable1.Grabber>
...
{
    [Serializable]
    public class UnityEventDraggable : UnityEvent<Draggable1> { }
    ...
    public virtual void OnBeginDrag(PointerEventData eventData)
    {
        ...
        switch (eventData.button)
        {
            ...
            case PointerEventData.InputButton.Right:
                GameObject.Find("Generator").GetComponent<Linker>().OnBeginDrag(this.gameObject);
                return;
    ...
    {
        if (!isGrabbed) { return; }
        if (ViveInput.GetPress(HandRole.LeftHand, ControllerButton.Menu) || ViveInput.GetPress(HandRole.RightHand, ControllerButton.Menu))
        {
        ...
        if(ViveInput.GetPress(HandRole.LeftHand, ControllerButton.Grip) || ViveInput.GetPress(HandRole.RightHand, ControllerButton.Grip))
        {
            ...
            {
                this.gameObject.GetComponent<AudioLink>().toggleLock();
            }
    ...
    {
        //if meun button Destroy (this.gameobject)
    ...
    public virtual void OnEndDrag(PointerEventData eventData)
    {
        if(eventData.button == PointerEventData.InputButton.Right)
        {
            ...
            {
                GameObject.Find("Generator").GetComponent<Linker>().OnEndDrag(eventData.pointerEnter);
            }
